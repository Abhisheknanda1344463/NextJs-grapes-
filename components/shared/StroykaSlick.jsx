...
class StroykaSlickBase extends Component {
  ...
  render() {
    const { children, forwardRef, locale, beforeChange, ...otherProps } =
      this.props;
    ...
    return (
      ...
      <div className={classes} onMouseDown={this.onMousedown} ref={this.setRef}>
        <Slick
          ...
          infinite={
            otherProps.infinite && React.Children.count(children) > slidesToShow
          }
...
export default React.forwardRef(function test(props, ref) {
  return <StroykaSlick forwardRef={ref} {...props} />;
});
